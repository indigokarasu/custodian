...
ls <hermes-source>/.venv/bin/python3
```

**Step 2: Install the missing package:**
```bash
<hermes-source>/.venv/bin/pip install <package>
```

**Step 3: Verify the import works:**
```bash
<hermes-source>/.venv/bin/python3 -c "from <module> import <thing>; print('OK')"
```

**Step 4: Run the actual script with the venv Python to confirm end-to-end:**
```bash
<hermes-source>/.venv/bin/python3 <script_path> --dry-run
```
...
3. Check pip install target: `<hermes-source>/.venv/bin/pip --version`
...
- **Fix applied:** `<hermes-source>/.venv/bin/pip install google-api-python-client`

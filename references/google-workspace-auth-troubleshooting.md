...
- Stores credentials in `~/.google_workspace_mcp/credentials/` as `<email>.json`
...
- **Indigo**: client `550801240087-vmc47b1gflj2biblqdr6bkekl7qqm8ls`, creds at `~/.google_workspace_mcp/credentials/mx.indigo.karasu@gmail.com.json`
- **owner**: client `112292610034-1revbmnkves56ago2c2t5dul5mj9bc17`, creds at `~/.google_workspace_mcp/credentials/google-workspace-user.json`
...
6. Save to the correct credential file (`~/.google_workspace_mcp/credentials/<email>.json`)

...
=======
Before creating a new issue, check `~/.hermes/commons/data/ocas-finch/task-list.json` for existing open tasks with the same root cause. Consolidate rather than duplicate.
>>>>>>> Stashed changes

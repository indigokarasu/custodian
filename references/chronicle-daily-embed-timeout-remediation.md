...
`<hermes-install>/.venv/bin/python <hermes-home>/scripts/chronicle_daily_embed.py`
...
(see `references/resolved-timeout-verify-drained-backlog.md`). Run the read-only probe:
    ...
    python3 <hermes-home>/skills/ocas-custodian/scripts/chronicle_embed_backlog_probe.py

...
- Root cause: Script imports `from google_auth_mcp import get_gmail_service` — this module doesn't exist as a standalone Python module. The credentials directory at `~/.google_workspace_mcp/credentials/` has valid files (google-workspace-user.json, 2868 bytes, updated 18:04).

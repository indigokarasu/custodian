...
cp ~/.hermes/commons/db/ocas-elephas/chronicle.lbug /tmp/chronicle_copy.lbug
...
cd <backup-repo>/commons/db/ocas-elephas && python3 elephas_cron_run.py

# 5. Sync changes back to main DB
cp /tmp/chronicle_copy.lbug ~/.hermes/commons/db/ocas-elephas/chronicle.lbug
```

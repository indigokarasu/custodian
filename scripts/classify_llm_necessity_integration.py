...
PROFILE = "indigo"
PROFILE_HOME = fos.path.expanduser("~/.hermes/profiles/{PROFILE}")
CLASSIFY_SCRIPT = fos.path.expanduser("~/.hermes/skills/ocas-custodian/scripts/classify_llm_necessity.py")

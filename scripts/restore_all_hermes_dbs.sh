...
cp $BACKUP_DIR/weave_lbug_* <backup-repo>/commons/db/ocas-weave/weave.lbug
...
# Restore MemPalace
tar -xzf $BACKUP_DIR/mempalace_*.tar.gz -C ~/.mempalace/
cp $BACKUP_DIR/chroma_db_* ~/.mempalace/palace/chroma.sqlite3
